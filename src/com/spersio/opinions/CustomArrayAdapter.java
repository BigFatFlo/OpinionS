...
public class CustomArrayAdapter extends ArrayAdapter<String> {
	...
	public CustomArrayAdapter(Context context, int row_layout_resource,int row_textview,
			List<String> data) {
		super(context, row_layout_resource, row_textview, data);
		
		CustomArrayAdapter.list = data;	
		CustomArrayAdapter.context = context;
		CustomArrayAdapter.row_layout_resource = row_layout_resource;
	...
	public View getView(final int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null) 
		{
			LayoutInflater mInflater = (LayoutInflater) CustomArrayAdapter.context
										.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
										
			convertView = mInflater.inflate(CustomArrayAdapter.row_layout_resource, parent, false);
